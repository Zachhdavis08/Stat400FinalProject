...
ggplot(covidData2, aes(x = population, y = deaths)) +
  geom_point(alpha = 0.5) +
  labs(title = "Population vs Deaths",
       x = "Population",
       y = "Deaths")

ggplot(covidData2, aes(x = pct_extreme_poverty, y = deaths)) +
  geom_point(alpha = 0.5) +
...
p-value: 2.2e-16 F-statistic: 647.2 Multiple R-squared: 0.8436
